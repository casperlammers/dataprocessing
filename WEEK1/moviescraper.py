...
def extract_movies(dom):
    ...
    for movie in dom.find_all('div', class_='lister-item-content'):
        ...
        # Add data from this movie to movielist
        movielist.append([title, rating, year, actors, runtime])

    # Return the movielist with its info
    return movielist
